...
cat svg"/persona.svg" | grep path | sort -t ',' -k2,2 -n > "tmp/"$persona".svg"
...
cat "tmp/"$persona"1_1.svg" | grep [0-4][13579][02468]: | sed 's/^[0-9]*://' > "tmp/"$persona"1.path.svg"
cat "tmp/"$persona"1_1.svg" "tmp/"$persona"1_2.svg" "tmp/"$persona"1_3.svg" "tmp/"$persona"1_4.svg" | awk -F ':' '{printf "%05d:%s\n", int(rand()*10000), $2;}' | grep 00: | sed 's/^[0-9]*://' >> "tmp/"$persona"1.path.svg"
...
cat "tmp/"$persona"1_2.svg" | grep [0-4][13579][02468]: | sed 's/^[0-9]*://' > "tmp/"$persona"2.path.svg"
cat "tmp/"$persona"1_1.svg" "tmp/"$persona"1_2.svg" "tmp/"$persona"1_3.svg" "tmp/"$persona"1_4.svg" | awk -F ':' '{printf "%05d:%s\n", int(rand()*10000), $2;}' | grep 00: | sed 's/^[0-9]*://' >> "tmp/"$persona"2.path.svg"
...
cat "tmp/"$persona"1_3.svg" | grep [5-9][13579][13579]: | sed 's/^[0-9]*://' > "tmp/"$persona"3.path.svg"
cat "tmp/"$persona"1_1.svg" "tmp/"$persona"1_2.svg" "tmp/"$persona"1_3.svg" "tmp/"$persona"1_4.svg" | awk -F ':' '{printf "%05d:%s\n", int(rand()*10000), $2;}' | grep 00: | sed 's/^[0-9]*://' >> "tmp/"$persona"3.path.svg"
...
cat "tmp/"$persona"1_4.svg" | grep [5-9][13579][13579]: | sed 's/^[0-9]*://' > "tmp/"$persona"4.path.svg"
cat "tmp/"$persona"1_1.svg" "tmp/"$persona"1_2.svg" "tmp/"$persona"1_3.svg" "tmp/"$persona"1_4.svg" | awk -F ':' '{printf "%05d:%s\n", int(rand()*10000), $2;}' | grep 00: | sed 's/^[0-9]*://' >> "tmp/"$persona"4.path.svg"
...
cat "res/"$persona""[1234]".svg"   >> "res/"$persona".global".svg
echo "</svg>"  >> "res/"$persona".global".svg


rm -f res/persona1.svg res/persona2.svg res/persona3.svg res/persona4.svg res/persona.red.svg res/persona.green.svg res/persona.blue.svg res/persona.maroon.svg res/persona.global.svg
